function [minutes_late,duration] = duration_route2(windows,workingTime,travelTime)
...
duration = travelTime(1)+sum(workingTime(1,:))+departure(n)-departure(1)+travelTime(n+1);
